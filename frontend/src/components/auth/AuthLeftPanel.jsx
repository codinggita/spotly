...
const AuthLeftPanel = () => {
  return (
    <div className="h-full w-full relative bg-[#0047FF] overflow-hidden flex flex-col justify-center px-12 lg:px-20">
      ...
      <div className="absolute inset-0 opacity-20 bg-[url('https://images.unsplash.com/photo-1506521781263-d8422e82f27a?auto=format&fit=crop&q=80')] bg-cover bg-center mix-blend-overlay"></div>
